...
export default function AdminSidebar({ isOpen, onClose }: AdminSidebarProps) {
    ...
    return (
        <>
            ...
            <aside className={`fixed inset-y-0 left-0 w-64 border-r border-slate-800 bg-slate-900 z-[70] flex flex-col transition-transform duration-300 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 md:static md:z-auto`}>
